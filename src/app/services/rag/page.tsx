...
const stats = [
  { value: "90-95%", label: "Retrieval Accuracy" },
  { value: "< 2s", label: "Response Time" },
  { value: "50K+", label: "Documents Indexed" },
  { value: "Source-Cited", label: "Every Answer" },
];
...
const capabilities = [
  ...
  },
  {
    ...
    features: ["Role-based learning", "Progress tracking", "Quiz generation", "Knowledge gap detection"],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const caseStudy = {
  metric: "63% Reduction in Support Tickets",
  ...
  result: "Self-service resolution rate hit 63%. Support response time dropped to 15 minutes for remaining tickets. Customer satisfaction score increased from 3.6 to 4.4.",
};

const faqs = [
  {
    question: "What is RAG?",
    answer: "Retrieval-Augmented Generation (RAG) is a technique where AI retrieves relevant information from your documents before generating a response. Think of it as giving AI a library card to your company\u2019s knowledge instead of relying on its general training. The AI grounds its answers in your actual knowledge base \u2014 reducing hallucinations and increasing accuracy.",
  },
  {

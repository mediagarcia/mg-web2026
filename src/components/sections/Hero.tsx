      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-0">
        <div className="max-w-4xl">
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center gap-6 text-sm text-black/50 pb-16 lg:pb-0"
          >
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#ff7a59]" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="font-medium">Gold HubSpot Partner</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">100+ Verified Reviews</span>
            </div>
          </motion.div>
        </div>
      </div>

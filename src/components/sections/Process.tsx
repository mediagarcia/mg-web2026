...
const steps = [
  {
    number: "01",
    title: "Discovery",
    description: "We dive deep into your business goals, current tech stack, and team workflows to understand exactly what you need.",
    icon: (
  ...
  },
  {
    number: "02",
    title: "Strategy",
    description: "We design a custom implementation plan aligned with your revenue goals and operational requirements.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    number: "03",
    title: "Build",
    description: "Our certified team implements your HubSpot configuration, integrations, and automation workflows.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    number: "04",
    title: "Launch",
    description: "We train your team, migrate your data, and go live with ongoing support to ensure success.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-[var(--spacing-section)] bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          ...
          >
            Our methodology ensures every implementation is strategic, efficient, and built to scale.
          </motion.p>
        </div>
